...
public class pdfmois
  {
     public void affichage(String mois, String entreprise, String filepath)
      {
        ...
        Integer salairetotal = 0;
          ...
          try
            ...
            Paragraph paramois = new Paragraph("Mois : "+ mois );
