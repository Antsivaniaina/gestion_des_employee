...
public class pdf2date
  {
     public void affichage(String date1,String date2, String entreprise, String filepath)
      {
          ...
          try
            {
              ...
              String requete2 = "SELECT employe.numemployer, employe.nom, employe.adresse, sum(travail.nbheure*travail.tauxhoraire) as salaire FROM employe ,travail, entreprise WHERE (employe.numemployer = travail.numemployer) AND (entreprise.numentreprise = travail.numentreprise) AND travail.numentreprise = ? AND dateembauche BETWEEN ? AND ? GROUP BY employe.numemployer ORDER BY salaire DESC ;";
            ...
            Paragraph paraannee = new Paragraph("Date : "+ date1 + " du "+date2 );
